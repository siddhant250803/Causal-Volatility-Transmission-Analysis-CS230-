================================================================================
   CAUSAL VOLATILITY TRANSMISSION - SYSTEM ARCHITECTURE (with Granger Validation)
================================================================================
...
│                                                                               │
│   Default: λ=0.0 (disabled), γ=0.001, η=0.001                                │
│                                                                               │
└──────────────────────────────────────────────────────────────────────────────┘
│
...
│                     (utils/granger_causality.py)                              │
├──────────────────────────────────────────────────────────────────────────────┤
│                                                                               │
│   STATISTICAL VALIDATION                                                      │
│   ┌────────────────────────────────────────────────────────────────────┐    │
│   │ For each source → target pair:                                      │    │
│   │   • Run F-tests at lags 1-12                                        │    │
│   │   • Test null hypothesis: "source does NOT Granger-cause target"   │    │
...
│   ┌────────────────────────────────────────────────────────────────────┐    │
│   │ Compare two methods:                                                 │    │
│   │   1. Neural Network Gates (learned attention)                       │    │
│   │   2. Granger Causality (classical F-tests)                          │    │
│   │                                                                      │    │
│   │ Report:                                                              │    │
│   │   • Relationships found by attention method                         │    │
│   │   • Relationships found by Granger method                           │    │
│   │   • Relationships validated by BOTH (high confidence)               │    │
│   └────────────────────────────────────────────────────────────────────┘    │
│                                                                               │
│   OUTPUT FILES                                                                │
│   ┌────────────────────────────────────────────────────────────────────┐    │
│   │ • results/STOCK_granger_causality.csv                               │    │
│   │ • results/STOCK_comparison.csv                                      │    │
│   └────────────────────────────────────────────────────────────────────┘    │
│                                                                               │
└──────────────────────────────────────────────────────────────────────────────┘
...
utils/
  ├─> __init__.py
  ├─> losses.py
  │    └─> CausalRegularizedLoss (MSE + TV + IRM)
  ├─> metrics.py
  │    └─> calculate_metrics (RMSE, MAE, R²)
  └─> granger_causality.py
       └─> GrangerCausalityTester (F-tests, validation)
